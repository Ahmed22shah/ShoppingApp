...
public class EmailSenderImpl implements EmailSender{
	...
	String emailSubject ="Haaris Infotec Admin";
	...
	public void welcomeUser(String email ) {
		message=" <br>Welcome to Haaris Infotec Pvt ltd .<br> Enjoy Shopping from Home.<br><br>We Integrate only Quality Product"
				+ "<br>We Trust in Customer Satisfaction  <br> Enjoy Quality World";
		String logo ="D:\\Spring\\IMS1\\Invoice_logo.png";
		 try {
	...
	private void sendEmail() throws MessagingException {
		// TODO Auto-generated method stub
		 String fromUser ="powerranger112200@gmail.com";            
		 String fromUserPassword = "Ahmedshah22";
	...
	String Signature ="<b style=\"color:red;\">Thanks & Regards</b><br>Mr Ahmed shah<br>"
